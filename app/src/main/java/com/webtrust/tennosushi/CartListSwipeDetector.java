...
/**
 * Класс, слушающий горизонтальные свайпы в {@link com.webtrust.tennosushi.fragments.ShoppingCartFragment}.
 * @author RareScrap
 */
public class CartListSwipeDetector implements View.OnTouchListener {
    /**
     * Перечисление, хранящие итендефикаторы действий, которые назначаются
     * полю {@link CartListSwipeDetector#mSwipeDetected}
     */
